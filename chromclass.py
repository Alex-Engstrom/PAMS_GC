...
class Chromatogram:
    ...
    def generatechrom(self):
        with ncdf.Dataset(self.filename, "r", format="NETCDF3_CLASSIC") as rootgrp:
            ...
            if "actual_run_time_length" in rootgrp.variables and "actual_delay_time" in rootgrp.variables:
                runtime = rootgrp.variables["actual_run_time_length"][:]
                starttime = rootgrp.variables["actual_delay_time"]
    ...
    def generateareas(self):
        with ncdf.Dataset(self.filename, "r", format="NETCDF3_CLASSIC") as rootgrp:
            ...
            return pd.DataFrame((peak_names, peak_amount))
        

if __name__ == "__main__":
    c1 = Chromatogram("C:/Users/aengstrom/Downloads/rbch06cdat-Front Signal.cdf", "cdf")
    print(c1.chromatogram)
